...
from .serializers import VotesSerializer,LikeSerializer
...
API
-Implemented like,dislike 
-Implemented comment view and create comment
-working on likes and follow request
